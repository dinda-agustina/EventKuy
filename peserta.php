...
document.addEventListener('DOMContentLoaded', (peserta) => {
    ...
    pesertaModal.addEventListener('show.bs.modal', function (peserta) {
        ...
        var idPeserta = button.getAttribute('data-idpeserta');
        ...
        var editPeserta = pesertaModal.querySelector('#editPeserta');
        var deletePeserta = pesertaModal.querySelector('#deletePeserta');
        ...
        editPeserta.href = "edit_peserta.php?id_peserta=" + idPeserta;
        deletePeserta.href = "proses_peserta.php?id_peserta=" + idPeserta;
    });
});
</script>
