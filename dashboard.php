...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    eventModal.addEventListener('show.bs.modal', function (event) {
        ...
        var editEvent = eventModal.querySelector('#editEvent');
        var deleteEvent = eventModal.querySelector('#deleteEvent');
        ...
        editEvent.href = "edit_event.php?id_event=" + idEvent;
        deleteEvent.href = "proses_event.php?id_event=" + idEvent;
    });
});
</script>