...
>
  <head>
    ...
    <title>Dashboard &mdash; EventKuy</title>
    <!-- Favicon -->
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="dashboard.php" class="app-brand-link">
              <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">EventKuy</span>
            </a>
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="event.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Event Baru</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Event">Peserta</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="peserta.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Data Peserta</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Event">Riwayat</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="riwayat_kategori.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Riwayat Kategori</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="riwayat_event.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Riwayat Event</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="riwayat_peserta.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Riwayat Peserta</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Event">Backup & Restore</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="index.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Backup/Restore</div>
                  </a>
                </li>
              </ul>
            </li>
