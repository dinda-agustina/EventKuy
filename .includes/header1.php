      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="dashboard1.php" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="dashboard1.php" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Event">Pendaftaran</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="peserta_form1.php" class="menu-link">
                    <div data-i18n="Basic Inputs">Daftar Peserta</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="peserta1.php" class="menu-link">
                    <div data-i18n="Input groups">Peserta</div>
                  </a>
                </li>
              </ul>
            </li>
