...
if ($row['admin_count'] > 0) {
    // If an admin already exists, redirect to an error page or display a message
    header("Location: akses_dilarang.php");
    exit();
}
?>
...
<head>
    ...
    <title>Register Admin &mdash; EventKuy</title>
    <!-- favicon -->
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /logo -->
                        <h4 class="mb-2" align="center" >Silahkan Daftar Admin! 😊</h4>
                        <form action="register_process_admin.php" class="mb-3" method="POST">
                            <div class="mb-3">
